...
#create plot1
png(file="plot1.png", width=480, height=480) #Open a PDF device we can plot to
with(powerdata.feb, hist(Global_active_power, col = "red", main="Global Active Power", xlab="Gloval Active Pwoer(kilowatts)"))
