...
#create plot4
png(file="plot4.png", width=480, height=480) #Open a PDF device we can plot to
par(mfcol=c(2,2))
with(powerdata.feb, plot(DateTime, Global_active_power, type = "l", xlab="", ylab="Global Active Power"))
...
with(powerdata.feb, plot(DateTime, powerdata.feb$Voltage, type = "l", xlab="datetime", ylab="Voltage"))
with(powerdata.feb, plot(DateTime, Global_reactive_power , type = "l", xlab="datetime"))
